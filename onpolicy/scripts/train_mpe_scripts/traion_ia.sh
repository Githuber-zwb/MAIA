...
do
    ...
    --n_training_threads 1 --n_rollout_threads 128 --num_mini_batch 1 --episode_length 100 --num_env_steps 20000000 \
    --ppo_epoch 10 --use_ReLU --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --use_wandb \
    --world_width 10.0 --world_length 50.0 --working_width 1.0 --headland_width 3.0 --ridge_width 0.3 --harvester_max_v 3.0 --transporter_max_v 5.0
done