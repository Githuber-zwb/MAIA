...
def make_polygon_with_clw(centerx, centery, width, length, filled=True):
    v = [(centerx - width /2 , centery - length / 2), (centerx - width /2 , centery + length / 2), 
         (centerx + width /2 , centery + length / 2), (centerx + width /2 , centery - length / 2)]
    if filled: return FilledPolygon(v)
    else: return PolyLine(v, True)
