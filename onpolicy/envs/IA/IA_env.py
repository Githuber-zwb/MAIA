...
if __name__ == "__main__":
    ...
    parser.add_argument("--cap_harvester", type=float, default=300.0, help="capacity of the harvester") 
    parser.add_argument("--cap_transporter", type=float, default=1000.0, help="capacity of the transporter")
    ...
    env.world.transporters[0].vel = np.array([0.3,0.4])
    # env.render_world()
    # time.sleep(10)
    ...
    for i in range(1000):
        ...
        action1 = np.random.rand(env.n, )
        actions = np.stack([action0, action1])
        # actions = np.random.ramd(env.n, 2)
        # print("actions: ", actions)
        # print("step: ", i, "actions: \n", actions, "\n")
        obs, rews,dones,infos = env.step(actions)
        # print("vel, pos: ", env.world.transporters[0].vel, env.world.transporters[0].pos)
