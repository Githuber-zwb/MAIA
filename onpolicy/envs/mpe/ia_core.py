...
class Harvester(object):
    def __init__(self, args, field, start_side = 0):
        self.i = 0
        self.name = ''
        self.color = None
        self.field = field
        self.dt = args.dt
        self.speed = args.harvester_max_v   # drive at maximum speed
        self.yeild_per_meter = args.yeild_per_meter
        self.capacity = args.cap_harvester
...
class Transporter(object):
    def __init__(self, args, field):
        ...
        self.field = field
        self.dt = args.dt
        self.capacity = args.cap_transporter
        self.transporting_speed = args.transporting_speed
        self.unloading_speed = args.unloading_speed
        self.max_velocity = args.transporter_max_v
...
class World(object):
    def __init__(self, args, field):
        ...
        self.dim_color = 3
        self.dim_c = 2
        self.harvesters = [Harvester(args, field) for _ in range(self.num_harvester)]
        self.transporters = [Transporter(args, field) for _ in range(self.num_transporter)]
    ...
    def step(self):
        ...
        for i, trans in enumerate(self.transporters):
            ...
            if np.linalg.norm(trans.pos - self.field.depot) < 1.0 and not trans.empty:
